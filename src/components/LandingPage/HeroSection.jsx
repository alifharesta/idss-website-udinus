...
export default function HeroSection() {
  ...
  return (
    <>
      <div className="min-h-[calc(100vh+2vh)] relative bg-center bg-no-repeat object-cover" style={{ backgroundImage: `url('/bg-hero-circullar.png')`, backgroundSize: 'cover' }}>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-left container mx-auto my-auto px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
            ...
            <div className="col-span-1 md:col-span-6 flex flex-col justify-center items-start gap-4 md:gap-6">
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 leading-tight font-poppins">
                IDSS
              </h1>
              <h1 className="text-2xl sm:text-3xl md:text-6xl font-bold text-gray-800 leading-tight font-poppins">
                Intelligent Distributed <br className="hidden sm:block" /> Surveilance and Security
              </h1>
              ...
              <div className="w-full mt-6 md:mt-12 flex flex-col sm:flex-row items-center gap-6">
                ...
                <div className="w-full sm:w-auto flex justify-center gap-8 sm:gap-12">
                  <div className="flex flex-col items-center">
                    <div className="text-gray-800 text-2xl sm:text-4xl md:text-[45.71px] font-medium uppercase font-poppins">50+</div>
                    <div className="text-gray-700 text-sm sm:text-base md:text-xl font-normal font-poppins">Publication</div>
                  </div>
                  <div className="flex flex-col items-center">
                    <div className="text-gray-800 text-2xl sm:text-4xl md:text-[45.71px] font-medium uppercase font-poppins">10+</div>
                    <div className="text-gray-700 text-sm sm:text-base md:text-xl font-normal font-poppins">Event</div>
                  </div>
                </div>
